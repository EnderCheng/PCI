...
public class Utils {
    ...
    public static int Nlength = 2048;
    public static int tau = 256;
    ...
    public static BigInteger powmod_special(BigInteger a, BigInteger r, BigInteger n) throws Exception
    {
        ...
        while(r.signum()==1)
        {
            if(r.mod(BigInteger.valueOf(2)).intValue()==1)
            {
    ...
    public static BigInteger[] three_squares(BigInteger n) throws Exception
    {
        ...
        if(n.mod(FOUR).signum()==0)
        {
            ...
            values[0] = values[0].multiply(BigInteger.valueOf(2));
            values[1] = values[1].multiply(BigInteger.valueOf(2));
            values[2] = values[2].multiply(BigInteger.valueOf(2));
            return values;
        }
        ...
        {
            BigInteger nsqrt = sqrt(n);
            BigInteger p,x;
            do{
                x = randomZbits(nsqrt.bitLength()-1);
                p = n.subtract(x.pow(2)).divide(BigInteger.valueOf(2));
        ...
        {
            return new BigInteger[]{sqrt(n),BigInteger.ZERO,BigInteger.ZERO};
        }
