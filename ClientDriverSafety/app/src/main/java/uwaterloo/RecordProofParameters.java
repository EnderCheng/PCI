...
public class RecordProofParameters {
    ...
    public RecordProofParameters(BigInteger ss_a, BigInteger ss_b, BigInteger ZZ_r, BigInteger ZGa_r,
                                 BigInteger D_r, BigInteger E_r, BigInteger U_tmp_r, RangeProofParameters p_a, RangeProofParameters p_b)
    {
        this.ss_a=ss_a;
        this.ss_b=ss_b;
        this.ZZ_r=ZZ_r;
