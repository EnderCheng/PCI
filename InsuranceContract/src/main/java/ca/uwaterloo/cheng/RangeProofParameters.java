...
public class RangeProofParameters {
    ...
    public RangeProofParameters(@JsonProperty("tau") BigInteger tau,
                                @JsonProperty("z_0") BigInteger z_0,
                                @JsonProperty("z_1") BigInteger z_1,
                                @JsonProperty("z_2") BigInteger z_2,
                                @JsonProperty("z_3") BigInteger z_3,
                                @JsonProperty("t_0") BigInteger t_0,
                                @JsonProperty("t_1") BigInteger t_1,
                                @JsonProperty("t_2") BigInteger t_2,
                                @JsonProperty("t_3") BigInteger t_3,
                                @JsonProperty("delta") BigInteger delta,
                                @JsonProperty("c") BigInteger c,
                                @JsonProperty("c_1") BigInteger c_1,
                                @JsonProperty("c_2") BigInteger c_2,
                                @JsonProperty("c_3") BigInteger c_3)
    {
        this.tau = tau;
